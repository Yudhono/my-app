    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="mx-auto max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          {/* Freelancer Info */}
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wide text-gray-400 mb-4">Info Kamu</h2>
            <div>
              <label htmlFor="freelancerName" className="block text-sm font-medium text-gray-700 mb-1">Nama / Nama Bisnis</label>
              <input
                id="freelancerName"
                name="freelancerName"
                type="text"
